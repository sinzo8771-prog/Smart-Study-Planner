  ...
  const faqs = [
    {
      ...
      answer: 'Simply click the "Get Started" button, create your account with email and password, and you can immediately start adding subjects and tasks. Our intuitive interface makes it easy to organize your studies.',
    },
    {
...
const AuthModal = ({ mode, onClose, onSwitchMode, onSuccess }: AuthModalProps) => {
            ...
            <form onSubmit={handleEmailLogin} className="space-y-3 sm:space-y-4">
              ...
              <div className="flex items-center gap-2">
                <label className="flex items-center gap-2 cursor-pointer">
                  ...
                  />
                  <span className="text-gray-500 dark:text-gray-400 text-sm">Remember me</span>
                </label>
              </div>
