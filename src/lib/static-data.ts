...
- Fundamental Theorem of Calculus`,
  ...
  },
  {
    ...
    description: 'Understand the fundamental laws of physics. Learn mechanics, thermodynamics, waves, and more with practical examples.',
...
- Modern Physics`,
  ...
  },
  {
    ...
    description: 'Learn chemistry from atomic structure to organic chemistry. Understand chemical reactions, bonding, and more.',
    thumbnail: 'https://i.ytimg.com/vi/Aoi4j8es4gQ/hqdefault.jpg',
    category: 'Science',
    level: 'beginner',
    duration: 540,
    isPublished: true,
...
- Microbiology`,
  ...
  },
  {
    ...
    description: 'Master English grammar from basics to advanced. Perfect for students and professionals who want to improve their writing.',
    thumbnail: 'https://i.ytimg.com/vi/TsYMJQEtpJU/hqdefault.jpg',
    category: 'Language',
    level: 'beginner',
    duration: 420,
    isPublished: true,
...
- Writing Tips`,
  ...
  },
  {
    ...
    description: 'Journey through human history from ancient civilizations to modern times. Understand key events, cultures, and transformations.',
...
- Modern Era`,
  ...
  },
  {
    ...
    description: 'Understand how economies work. Learn microeconomics, macroeconomics, and key economic principles.',
...
- International Trade`,
  ...
  },
  {
    ...
    description: 'Learn to manage your money effectively. Budgeting, investing, saving, and building wealth for your future.',
    thumbnail: 'https://i.ytimg.com/vi/NEzqHbtGa9U/hqdefault.jpg',
    category: 'Finance',
    level: 'beginner',
    duration: 360,
    isPublished: true,
...
export const staticQuizzes: StaticQuiz[] = [
  ...
  },
  {
    ...
    questions: [
      ...
      },
      {
        ...
        optionA: 'Energy of position',
        optionB: 'Energy of motion',
        optionC: 'Thermal energy',
        optionD: 'Chemical energy',
        correctAnswer: 'B',
      ...
      },
      {
        ...
        optionA: 'speed = force × time',
        optionB: 'speed = distance / time',
        optionC: 'speed = mass × acceleration',
        optionD: 'speed = energy / mass',
        correctAnswer: 'B',
    ...
    questions: [
      {
        ...
        optionA: 'Their going to the store.',
        optionB: 'Theyre going to the store.',
        optionC: "They're going to the store.",
        optionD: 'There going to the store.',
        correctAnswer: 'C',
      ...
      },
      {
        ...
        optionD: 'writing',
        correctAnswer: 'B',
        explanation: '"Write" becomes "wrote" in past tense.',
        points: 1,
        order: 2,
        createdAt: new Date(),
      },
      {
        ...
        optionD: 'mountain',
        correctAnswer: 'B',
        explanation: 'Paris is a specific place, so it is a proper noun.',
        points: 1,
        order: 3,
        createdAt: new Date(),
      },
      ...
      },
      {
        ...
        optionD: 'Noun',
        correctAnswer: 'B',
        explanation: '"Quickly" is an adverb describing how something is done.',
        points: 1,
        order: 5,
        createdAt: new Date(),
      }
  ...
  },
  {
    ...
    questions: [
      ...
      },
      {
        id: 'q-hist-1-5',
        quizId: 'quiz-hist-1',
        question: 'What was the name of the trade route connecting East and West?',
        optionA: 'Silk Road',
        optionB: 'Spice Route',
        optionC: 'Gold Trail',
        optionD: 'Trade Way',
        correctAnswer: 'A',
        explanation: 'The Silk Road connected East and West for trade.',
        points: 1,
        order: 5,
        createdAt: new Date(),
      }
    ...
    questions: [
      {
        ...
        optionA: 'Price up, supply down',
        optionB: 'Price up, supply up',
        optionC: 'Price down, supply up',
        optionD: 'Price has no effect on supply',
        correctAnswer: 'B',
        explanation: 'As price increases, producers supply more.',
        points: 1,
        order: 1,
        createdAt: new Date(),
      },
      {
        ...
        optionA: 'General Domestic Product',
        optionB: 'Gross Domestic Product',
        optionC: 'Gross Domestic Profit',
        optionD: 'General Domestic Profit',
        correctAnswer: 'B',
      ...
      },
      {
        ...
        optionA: 'Decrease in prices',
        optionB: 'Increase in prices over time',
        optionC: 'Stable prices',
        optionD: 'Decrease in money supply',
        correctAnswer: 'B',
      ...
      },
      {
        ...
        optionA: 'Money spent on opportunities',
        optionB: 'Value of the next best alternative',
        optionC: 'Cost of production',
        optionD: 'Total expenses',
        correctAnswer: 'B',
      ...
      },
      {
        id: 'q-econ-1-5',
        quizId: 'quiz-econ-1',
        question: 'Who controls monetary policy in the US?',
        optionA: 'Congress',
        optionB: 'President',
        optionC: 'Federal Reserve',
        optionD: 'Treasury Department',
        correctAnswer: 'C',
        explanation: 'The Federal Reserve controls monetary policy.',
        points: 1,
        order: 5,
        createdAt: new Date(),
      }
  ...
  },
  {
    ...
    description: 'Test your personal finance knowledge',
    courseId: 'course-fin-1',
    duration: 15,
    passingScore: 60,
    isPublished: true,
    ...
    questions: [
      {
        ...
        optionA: 'Money for vacations',
        optionB: 'Savings for unexpected expenses',
        optionC: 'Investment account',
        optionD: 'Credit card limit',
        correctAnswer: 'B',
        explanation: 'An emergency fund is savings for unexpected expenses.',
        points: 1,
        order: 1,
        createdAt: new Date(),
      },
      {
        ...
        optionB: 'Interest on principal and accumulated interest',
        optionC: 'Fixed interest rate',
        optionD: 'Interest paid by banks',
        correctAnswer: 'B',
        explanation: 'Compound interest is interest earned on principal and accumulated interest.',
        points: 1,
        order: 2,
        createdAt: new Date(),
      },
      {
        ...
        optionB: 'A retirement savings plan',
        optionC: 'A bank account',
        optionD: 'A type of insurance',
        correctAnswer: 'B',
        explanation: 'A 401(k) is an employer-sponsored retirement savings plan.',
        points: 1,
        order: 3,
        createdAt: new Date(),
      },
      {
        ...
        optionA: '1 month of expenses',
        optionB: '3-6 months of expenses',
        optionC: '1 year of expenses',
        optionD: '2 weeks of expenses',
        correctAnswer: 'B',
        explanation: '3-6 months of expenses is recommended for an emergency fund.',
        points: 1,
        order: 4,
        createdAt: new Date(),
      },
      {
        ...
        optionA: 'Investing in one stock',
        optionB: 'Spreading investments across different assets',
        optionC: 'Keeping all money in cash',
        optionD: 'Buying only bonds',
        correctAnswer: 'B',
